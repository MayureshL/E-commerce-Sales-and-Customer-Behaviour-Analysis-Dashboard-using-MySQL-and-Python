...
#1. Top 10 Customer Cities by Number of Customers
...
#3. Analyze total sales generated across product categories to identify top-performing categories.
SELECT 
...
#4. Calculate the prcentage of orders that were paid through installaments
SELECT 
ROUND(
...
#5. Calculate  the number of customers from each state
SELECT customer_state, COUNT(customer_id) AS customer_count
FROM customers
GROUP BY customer_state;

#6. Monthly order trend in 20218
SELECT 
...
#7. Identify cities with the highest average products purchased per order
...
#8. Calculate the the percentage of total revenue contributed by each product category
SELECT 
    UPPER(products.product_category) AS category,
    ROUND(
...
#13. Track cumulative monthly sales across years to compare revenue growth patterns
SELECT 
    sales_year,
    sales_month,
    monthly_sales,
...
#14. Calculate the retention rate of customers, defined as thepercentage of customers who make another purchase within 6 months
